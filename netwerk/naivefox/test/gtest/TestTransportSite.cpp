...
TEST(NaiveFoxTransportSite, DiscoversAllDirectKindsAndDeduplicates)
{
  const char* html =
...
TEST(NaiveFoxTransportSite, IgnoresInertAndSecondaryContent)
{
  const char* html =
...
TEST(NaiveFoxTransportSite, StreamingUTF8AndEntities)
{
  const char* html =
...
TEST(NaiveFoxTransportSite, NoFixedDocumentOrResourceCountBudget)
{
...
TEST(NaiveFoxTransportSite, RootOnlyAndDataIcon)
{
...
TEST(NaiveFoxTransportSite, RejectsUnsupportedAndUnsafeGraphs)
{
  for (const char* html :
...
TEST(NaiveFoxTransportSite, RejectsBrokenUTF8AtEveryBoundary)
{
