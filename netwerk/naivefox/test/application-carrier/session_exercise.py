...
def state(worker):
    ...
    value = worker.execute_script("return {phase:window.__NFC_PHASE__,alive:!!window.__NFC_ALIVE__,error:window.__NFC_ERROR__,dynamic:window.__NFC_DYNAMIC_ROUNDS__,idle:window.__NFC_IDLE_POLLS__,wake:window.__NFC_IDLE_WAKE_POSTS__,frame_parts:window.__NFC_FRAME_PARTS__||0,early_frame_parts:window.__NFC_EARLY_FRAME_PARTS__||0,frame_bytes_pending:window.__NFC_FRAME_BYTES_PENDING__||0,deferred_deliveries:window.__NFC_DEFERRED_DELIVERIES__||0,bulk_pairs:window.__NFC_BULK_PAIRS__||0,pipelined_pairs:window.__NFC_PIPELINED_PAIRS__||0}")
