...
- **Validated Minimal Audit Source Commit:** `4f9d5ac4d99f` (full SHA is recorded in the closure reports)
- **Validated Minimal Report Commit:** `a8a7f1d18458` (report-only child of the audit source commit)
