...
TEST(NaiveFoxTransportWebSocket, BlockedConsumerRejectsFillerFlood)
{
...
TEST(NaiveFoxTransportWebSocket, BlockedConsumerBoundsBytesAndReleasesBudget)
{
  RefPtr<WebSocketChannel> channel = new WebSocketSSLChannel();
  RefPtr<MessageCounter> listener = new MessageCounter();
  nsCOMPtr<nsIThread> producer;
...
TEST(NaiveFoxTransportWebSocket, BlockedWriterRejectsPingFlood)
{
  RefPtr<WebSocketChannel> channel = new WebSocketSSLChannel();
  RefPtr<MessageCounter> listener = new MessageCounter();
...
TEST(NaiveFoxTransportWebSocket, RejectsUnsolicitedCompressionBeforeReading)
{
  RefPtr<WebSocketChannel> channel = new WebSocketSSLChannel();
  RefPtr<MessageCounter> listener = new MessageCounter();
