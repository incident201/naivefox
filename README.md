...
- See [HTTPS.md](netwerk/naivefox/HTTPS.md) for PIN configuration, security and recovery.
...
a support guarantee. See [CDN.md](netwerk/naivefox/CDN.md) and [TRANSPORT.md](netwerk/naivefox/TRANSPORT.md).
...
must retain that dependency boundary. See [ARCHITECTURE.md](netwerk/naivefox/ARCHITECTURE.md),
